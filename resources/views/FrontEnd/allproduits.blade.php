			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<li class="p-t-4 {{ Request::is('produits') ? 'sale-noti' : '' }}">
						    ...
						    <li class="p-t-4 {{ Request::segment(1) == $categorie->cat_name ? 'sale-noti' : '' }}"><a class="s-text13" href="{{url('/produits')}}/{{$categorie->cat_name}}">{{$categorie->cat_name}}</a>
						    </li>
						 @endforeach
						</ul>
